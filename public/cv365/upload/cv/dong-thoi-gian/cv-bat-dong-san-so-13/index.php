                            ...
                            <div id="experience-table">
                                ...
                                ?>
                                    ...
                                    <?php if ($bl->subtitle != '') { ?>
                                        ...
                                        <p class="h3">
                                            <span class="exp-subtitle" cvo-placeholder="<?php echo $holder_block_job; ?>" contenteditable="true"><?php echo $bl->subtitle; ?></span>
                                        </p>
                                    <?php } ?>
...
<script>
    ...
    //     let height = `${(height1) - 451}px`;
    //     $("#cv-content").css("margin-top", height);
    // })

    // $('.chu').on('keyup', function(){
    //     let temp = $(this).height();
    //     let height1 = $('#box-hvt').height();
    //     let height = `${(height1-315)-temp}px`;
    //     $('#cv-content').css("margin-top", height)
    //     }  
    // )
    // function changerate(){
    //     var ctbxs = document.getElementsByClassName('ctbx');
    //     for(i=0;i<ctbxs.length;i++){
    //         var ctbxchilds = ctbxs[i].children;
    //         var rate = ctbxchilds[3].firstElementChild.value;
    //         try{
    //             if(!ctbxchilds[2].firstChild.firstChild){
    //                 var el = document.createElement('div');
    //                 el.setAttribute('class', 'kn_rate');
    //                 var el1 = document.createElement('span');
    //                 el1.innerHTML = rate+"%";
    //                 el.appendChild(el1);
    //                 ctbxchilds[2].firstChild.appendChild(el);
    //             }
    //         }catch(error){}
    //     }
    // }
    // setInterval(changerate, 100);
</script>