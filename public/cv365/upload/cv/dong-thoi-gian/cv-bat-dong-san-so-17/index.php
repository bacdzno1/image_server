            ...
            <div id="cvo-profile">
                <div class="chu">
                    <div class="bg-chu">
                        ...
                        <div class="clr"></div>
                        <h2><div id="cv-profile-job" contenteditable="true" cvo-placeholder="<?php echo $holder_job; ?>"><?php echo $position; ?></div></h2>
                    </div>
                </div>
                <div class="anh">
                ...
                <div class="box-01">
                    <div id="box-hvt">
                        ...
                        ?>
                                <div id="prof">
                                    <div class="i_tt">Thông tin</div>
                                    <div class="i_le">
                                        <div class="ic ic1">
                                            <div class="icf"><i class="fa"></i></div>
                                            <div class="icoweb"><div id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></div></div>
                                        </div>
                                        
                                        <div class="ic ic3">
                                            <div class="icf"><i class="fa"></i></div>
                                            <div class="icoweb"><div id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></div></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="i_ri">
                                        <div class="ic ic5">
                                            <div class="icf"><i class="fa"></i></div>
                                            <div class="icoweb"><div id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></div></div>
                                        </div>
                                        <div class="ic ic2">
                                            <div class="icf"><i class="fa"></i></div>
                                            <div class="icoweb"><div id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></div></div>
                                        </div>
                                        <div class="ic ic4">
                                            <div class="icf"><i class="fa"></i></div>
                                            <div class="icoweb"><div id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                                                        echo $email;
                                                                                                                                                                    } else {
...
<script>
  let ranh = () => {
    ...
    let Height = $('#box-hvt').offsetHeight;
    let Height1 = $('#box02').offsetHeight;
    let Height2 = $('#cv-profile-job').offsetHeight;
    
    $('#box02').style.marginTop = `${(Height) - 58}px`;
    $('#cv-content').style.marginTop = `${(Height + Height1) - 379}px`;
