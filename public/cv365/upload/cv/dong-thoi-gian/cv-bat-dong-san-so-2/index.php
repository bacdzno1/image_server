                                ...
                                <?php if ($m['type'] == "profile") { ?>
                                    ...
                                    <div id="prof">
                                        ...
                                        <div class="ic">
                                            ...
                                            <p class="icoweb">
                                                Email:
                                                <span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                                        echo $email;
                                                                                                                                                    } else {
                                        ...
                                        <div class="ic">
                                            <p class="icf"><i class="fa">&#xf041;</i></p>
                                            <p class="icoweb">Địa chỉ:<span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></span></p>
                                        </div>
                                        <div class="ic">
                                            <p class="icf"><i class="fa">&#xf129;</i></p>
                                            <p class="icoweb">
                                                Facebook:<span id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></span></p>
                                        </div>
                                        <div class="clr"></div>
                                    </div>
                                    <div class="clr"></div>
