        ...
        <div id="cv-top">
            ...
            <div class="box-left">
                <div id="box-hvt">
                    ...
                    <p class="id"><span id="cv-profile-about"></span></p>
                </div>
                ...
                <div class="box-info">
                    ...
                    ?>
                                ...
                                <div class="quat">
                                    <div class="taoicon" id="phone"><i class="fa">&#xf1fd</i>
                                    </div>
                                ...
                                <div class="quat">
                                    <div class="taoicon" id="mail"></div>
                                    <p class="icoweb cvi-envelope-square"><span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                                                                echo $email;
                                                                                                                                                                            } else {
                                ...
                                <div class="quat">
                                    <div class="taoicon" id="location"></div>
