...
<div id="page-cv">
    ...
    <div id="form-cv">
        <div class="cv_tt">
                     ...
                     <div class="ir">
                        <div id="sortable">
    						...
    						<?php if($m['type']=="profile"){ ?>
                                ...
                                <p class="icoweb cvi-date">Ngày sinh:<span id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></span></p>
                                <p class="icoweb cvi-user">Giới tính:<span id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></span></p>
                                <p class="icoweb cvi-phone">Số điện thoại:<span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></span></p>
                                <p class="icoweb cvi-envelope-square">Email:<span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if(isset($email)){echo $email;}else{echo $m['content']->email;} ?></span></p>
                                <p class="icoweb cvi-map-marker">Địa chỉ:<span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></span></p>
          ...
          <div class="ft"><div class="watermark">© Timviec365.vn</div></div>
    </div>
