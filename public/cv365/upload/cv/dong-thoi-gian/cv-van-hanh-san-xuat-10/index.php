<link rel="stylesheet" href="upload/cv/<?php echo $item->alias; ?>/css/cv.css?v=2" type="text/css">
                ...
                <div class="box-01">
                    ...
                    ?>
                            ...
                            <div id="prof">
                                ...
                                <div class="ic-phone">
                                    <p class="icf"><i class="fa">&#xf095;</i></p>
                                    <p class="icoweb"><span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php if (isset($phone)) {
                                                                                                                                                            echo $phone;
                                                                                                                                                        } else {
                                                                                                                                                            echo $m['content']->phone;
                                                                                                                                                        } ?></span></p>
                                </div>
                                <div class="email"></div>
                                <div class="ic-email">
                                    <p class="icf"><i class="fa">&#xf0e0;</i></p>
                                    <p class="icoweb"><span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                                            echo $email;
                                                                                                                                                        } else {
                                ...
                                <div class="ic-address">
                                    <p class="icf"><i class="fa">&#xf041;</i></p>
                                    <p class="icoweb"><span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php if (isset($address)) {
                                                                                                                                                                echo $address;
                                                                                                                                                            } else {
                                                                                                                                                                echo $m['content']->address;
                                                                                                                                                            } ?></span></p>
                                </div>
                                <div class="clr"></div>
                            </div>
