...
<div id="page-cv">    
    ...
    <div id="form-cv" class="bd">
        <div id="cv-top" class="bg">
            <div id="cvo-profile">
                ...
                <div class="ir">
                    <div id="sortable">
						...
						<?php if($m['type']=="profile"){ ?>
                            <p class="icoweb"><i class="fa fa-phone bg"></i><span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></span></p>

                            <p class="icoweb"><i class="fa fa-envelope bg"></i><span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if(isset($email)){echo $email;}else{echo $m['content']->email;} ?></span></p>

                            <p class="icoweb"><i class="fa fa-info bg"></i><span id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></span></p>	 

                            <p class="icoweb"><i class="fa fa-user bg"></i><span id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></span></p>   

                           <p class="icoweb"><i class="fa fa-calendar bg"></i><span id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></span></p>

                            <p class="icoweb"><i class="fa fa-map-marker bg"></i><span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></span></p>
                            
                            <div class="clr"></div>
						<?php }else if($m['type']=="skill"){ ?>

                            <p class="h3 cr"><span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></span></p>
						...
						<?php }else{
                            ?><p class="h3 cr">
                                <span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></span><?php
                            switch ($i) {
                                case '1':
                                    ?> <i class="fa fa-lightbulb-o"></i> <?php
                                    break;
                                case '2':
                    ...
                    <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?>>
                        ...
                        <div id="experience-table">
							...
							?>
                                ...
                                <?php if($bl->date!=''){ ?>
                                <span class="exp-date cr" contenteditable="true" cvo-placeholder="<?php echo $holder_block_time; ?>"><?php echo $bl->date; ?></span>
                                <?php } ?>
                                </h3>
                                <?php } ?>
