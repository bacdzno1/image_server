...
<link id="cv-color-css" rel="stylesheet" href="upload/cv/<?php echo $item->alias; ?>/css/colors/<?php echo $color_active; ?>.css?v=<?= $styleVersion ?>?v=1" type="text/css">
                        ...
                        <div id="sortable">
                            ...
                            ?>
                                    <?php if ($m['type'] == "profile") { ?>
                                        <div class="icoweb cvi-date"><div id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></div></div>
                                        <div class="icoweb cvi-user"><div id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></div></div>
                                        <div class="icoweb cvi-phone"><div id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></div></div>
                                        <div class="icoweb cvi-envelope-square"><div id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                                                                    echo $email;
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo $m['content']->email;
                                                                                                                                                                                } ?></div></div>
                                        <div class="icoweb cvi-map-marker"><div id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></div></div>
                                        <div class="icoweb cvi-info"><div id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></div></div>
