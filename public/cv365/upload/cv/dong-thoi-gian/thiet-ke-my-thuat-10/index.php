        ...
        <div id="cv-top">
            <div id="cvo-profile">
                ...
                <div class="box-01">
                    ...
                    <?php for ($i = 1; $i <= count($menu_html); $i++) {
                        $m = $menu_html[$i];
                        if ($m['type'] == "profile") {
                    ...
                    ?>
                            ...
                            <div id="prof">
                                <div class="ic">
                                    <div class="icf1"><i class="fa">&#xf073;</i></div>
                                ...
                                <div class="ic">
                                    <div class="icf2"><i class="fa">&#xf228;</i></div>
                                ...
                                <div class="ic">
                                    <div class="icf3"><i class="fa">&#xf095;</i></div>
                                ...
                                <div class="ic">
                                    <div class="icf4"><i class="fa">&#xf199;</i></div>
                                ...
                                <div class="ic">
                                    <div class="icf5"><i class="fa">&#xf041;</i></div>
