                ...
                <div class="ir">                    
                    <div id="sortable">
						...
						<?php }else if($m['type']=="skill"){ ?>
                            <?php echo $controls; ?>
                        <div class="z-exp">
                        <h3><div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div><div class="wfa"><i class="fa">&#xf0b1;</i></div></h3></div>
                        <div class="clr"></div>
						...
						<?php }else{ ?>
                            ...
                            <div class="z-exp">
                                <h3>
                                <div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div><div class="wfa"><i class="fa">&#xf02d;</i></div></h3>
                            </div>
        ...
        <div id="cv-content">
            <div class="ir" id="sort_block">
                ...
                <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?>>                    
                    ...
                    <div id="experience-table" class="w-exp">
                        <?php
                        $j=0;
