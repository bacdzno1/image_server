const CV = () => {
			...
			<div id="page-cv">
				...
				<div id="form-cv">
					<div className="cv_page height_page" data-page={1}>
						...
						<div className="all" style={{ paddingTop: '26.6px' }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '0.566667px' }}>
												{' '}
   ...
   THÔNG TIN LIÊN HỆ</div></div> */}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '0.566667px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '0.566667px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box04" className="block cvo-block ui-sortable-handle" style={{ marginTop: '0.566667px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box05" className="block cvo-block ui-sortable-handle" style={{ marginTop: '0.566667px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box06" className="block cvo-block ui-sortable-handle" style={{ marginTop: '0.566667px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '19.95px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '13.3px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '19.95px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											...
											<div id="exp2" className="ctbx experience" style={{ marginTop: '13.3px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{ paddingBottom: '885.4px' }}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
