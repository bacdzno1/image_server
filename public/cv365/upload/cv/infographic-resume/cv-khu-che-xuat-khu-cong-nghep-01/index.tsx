			...
			<div id="page-cv">
				...
				<div id="form-cv">
					<div className="cv_page height_page" data-page={1}>
						...
						<div className="all" style={{ paddingTop: '34.125px' }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '25.5938px' }}>
												{' '}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '25.5938px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div
													...
													style={{ marginTop: '25.5938px' }}
												>
													- Có thể tìm hiểu và đưa tay nghề kỹ thuật của mình lên một tầm cao mới để giúp tối giản sức lao động cho người lao động là
													niềm đam mê mà tôi luôn phấn đấu hết mình trong quá trình làm việc. Chính vì thế, dù ở môi trường nào tôi cũng muốn cố gắng
													thật nhiều để cống hiến nhiều nhất sức lực và khả năng của mình.
													<br />- Mong muốn của tôi là được làm việc trong môi trường chuyên nghiệp. Với sự phát triển mạnh mẽ của công ty nói riêng
													và toàn khu công nghiệp ABC nói riêng, tôi hy vọng có thể học hỏi, tích lũy được nhiều kinh nghiệm việc làm hơn nữa để vừa
													có thể củng cố tay nghề kỹ thuật của mình, vừa có thể tham gia hiệu quả vào quá trình phát triển doanh nghiệp.
													<br />- Trong tương lai, tôi sẽ cố gắng để trở thành một nhà quản lý mẫu mực, có khả năng truyền nhiệt huyết và cảm hứng lớn
													với công việc cho nhân viên để từ đó có thể xây dựng nên một đội ngũ đoàn kết, vững mạnh và có chất lượng làm việc tốt
													nhất.&nbsp;{' '}
												</div>
											</div>{' '}
										</div>
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '18.7188px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '12.4792px' }}>
												{' '}
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="Tên công ty">
														Đại học Sư phạm kỹ thuật Hà Nội (9/2011- 7/2015)
													</div>
												</h3>
												<p className="h3">
											...
											<div id="exp2" className="ctbx experience" style={{ marginTop: '12.4792px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="Tên công ty">
														Trung tâm đào tạo nghề AZ (7/2014-7/2015)
													</div>
												</h3>
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '18.7188px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
						...
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '1.144px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box04" className="block cvo-block ui-sortable-handle" style={{ marginTop: '1.144px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box06" className="block cvo-block ui-sortable-handle" style={{ marginTop: '1.144px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box07" className="block cvo-block ui-sortable-handle" style={{ marginTop: '1.144px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
					...
					<div className="cv_page page_more height_page" data-page={3}>
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{ paddingBottom: 957 }}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable" />
									</div>
