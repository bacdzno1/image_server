...
<div id="page-cv"> 
    ...
    <div id="form-cv">
        <div id="cv-main">
        	<div id="cv-content">
        		<div id="cvo-profile-info" class="bg-top">
	                <div class="hewifew">
	                	<h1><span id="cv-profile-fullname" cvo-placeholder="<?php echo $holder_name; ?>" contenteditable="true"><?php echo $fullname; ?></span></h1>
	                	<h2 class="color-right"><span id="cv-profile-job" contenteditable="true" cvo-placeholder="<?php echo $holder_job; ?>"><?php echo $position; ?></span></h2>
	                </div>
	            </div> 
	                            ...
	                            ?>
	                                ...
	                                <h3>
		                                ...
		                                <div class="xyz">
			                                ...
			                                <?php if($bl->date!=''){ ?>
			                                <span class="exp-date color-right" contenteditable="true" cvo-placeholder="<?php echo $holder_block_time; ?>"><?php echo $bl->date; ?></span>
			                                <?php } ?>
		                                </div>
	        ...
	        <!-- Hết CV content -->
        	<div id="cv-center" class="bg-right">
	            <div id="cv-top" class="">
	                <div id="cvo-profile">                
	                    <div class="box-01">
	                    	<!-- <p class="h3 bg color"><span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="Profile" class="box-title">Profile</span></p> -->
		            ...
		            <div class="ir">                
		                    <div id="sortable">
		                        ...
		                        <?php if($m['type']=="profile"){ ?> 
		                        	<p class="h3"><span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title bg-top"><?php echo $m['title']; ?></span></p>
		                        ...
		                        <?php }else{ ?>
		                            <?php echo $controls; ?>
		                            <p class="h3">
		                            <span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title bg-top"><?php echo $m['title']; ?></span></p>
