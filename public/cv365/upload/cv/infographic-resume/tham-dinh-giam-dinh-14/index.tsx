			...
			<div id="page-cv">
				...
				<div id="form-cv">
					<div className="cv_page height_page" data-page={1}>
						...
						<div className="all" style={{ paddingTop: '49.6px' }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '14.8px' }}>
												{' '}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '14.8px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '14.8px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '37.2px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
									...
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '37.2px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '37.2px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="Tên công ty">
														<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[0]?.title}` }} />
													</div>
													<div className="bg-date">
														<div className="exp-date" contentEditable="true" cvo-placeholder="Thời gian làm việc">
															<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[0]?.date}` }} />
														</div>
													</div>
												</h3>
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
														<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[0]?.subtitle}` }} />
													</span>
												</p>
												<div
													className="exp-content"
													...
													cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
												>
													<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[0]?.content}` }} />
												</div>
											</div>{' '}
										</div>
									</div>
									...
									<div id="block01" className="cvo-block ui-sortable-handle">
										<div id="experience-table">
											<div id="exp2" className="ctbx experience">
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="Tên công ty">
														<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[1]?.title}` }} />
													</div>
													<div className="bg-date">
														<div className="exp-date" contentEditable="true" cvo-placeholder="Thời gian làm việc">
															<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[1]?.date}` }} />
														</div>
													</div>
												</h3>
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
														<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[1]?.subtitle}` }} />
													</span>
												</p>
												<div
													className="exp-content"
													...
													cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
												>
													<div dangerouslySetInnerHTML={{ __html: `${html?.experiences[0]?.content?.content[1]?.content}` }} />
												</div>
											</div>
										</div>
									</div>
