				...
				<div id="form-cv">
						...
						<div className="all" style={{ paddingTop: 0 }}>
                                          ...
                                          <div class="icoweb"><span id="cv-profile-sex" cvo-placeholder="성별 " contenteditable="true">남성</span></div>
											...
											<div id="box02" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
													모든 배정 된 업무를 기한에 맞게 완료하기 위해 전문 지식과 관련 경험을 적용합니다.향후 1-2 년 이내 더 높은 소득으로 위치로
													진급할 수 있기위해 경험을 축적하고 전문적인 기술을 더 향상하길 원합니다.&nbsp;{' '}
												</div>
											</div>{' '}
										</div>
									</div>
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '29.35px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '19.5667px' }}>
												{' '}
												...
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
														{' '}
														전공: 로지스틱스 및 공급 체인 관리2011/8-2015/6
													</span>
												</p>
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '29.35px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '19.5667px' }}>
												...
												>
													새로운 고객을 찾아 접근함.-기존 고객을 돌보고 정책 및 규정을 준수하여 회사의 이익을 보호함예산 및 할당 된 작업을
													완료함.&nbsp;영업 부서의 감독 및 관리를 위해 비즈니스 상황에 대한 보고서를 작성함.{' '}
												</div>
											</div>
											<div id="exp2" className="ctbx experience" style={{ marginTop: '19.5667px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> 추가
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="회사명">
														CV365 로지스틱스 주식회사기간: 2016/1~2016/12
													</div>
												</h3>
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
												...
												<div
													...
													cvo-placeholder=" 업무에서 달성되는 업무 세부 사항을 설명한다."
												>
													일일 수량 데이터 입력창고 지역에서 상품 관리, 정리일일 수량 보고서 작성상사의 요청이 있을 때 관련 작업을 수행함.&nbsp;{' '}
												</div>
											</div>{' '}
										</div>
										<div className="form" />
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
									...
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											...
											<div id="box04" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
													“2014년 무역 대학교의 가장 우수한 자원봉사자” 호칭을 받았음.&nbsp;“토착민과의 영어 커뮤니케이션” 대회 일등{' '}
												</div>
											</div>
											<div id="box05" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
													사무실용 컴퓨터 공학종합 회계 자격증&nbsp;유통 물류 자격증{' '}
												</div>
											</div>
											...
											<div id="box07" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
													Ms. Nguyen Thach Bao Ngoc&nbsp;CV365 1인 유한책임회사 부사장전화번호: 036 787 9999{' '}
												</div>
											</div>
										</div>
									</div>
							...
							<div id="cv-content" style={{ paddingBottom: '431.4px' }}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block03" className="cvo-block ui-sortable-handle" style={{ marginTop: 0 }}>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: 0 }}>
												...
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
														역할: CV365 1인 유한책임회사의 화물 운송 영업 직원
													</span>
												</p>
												<div
													className="exp-content err_cv_content"
													...
													cvo-placeholder=" 업무에서 달성되는 업무 세부 사항을 설명한다."
												>
													결과: 단 2개월 만 이내 회사의 매출이 30%로 증가했음
													<br />{' '}
												</div>
											</div>{' '}
										</div>
									...
									<div id="block04" className="cvo-block ui-sortable-handle" style={{ marginTop: 0 }}>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: 0 }}>
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="회사명">
														Coach Design- 기업용 그래픽 디자인 교육 프로젝트
													</div>
												</h3>
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
														직위: 프로젝트 관리, 오리엔테이션 작업 구현, 프로젝트 목표 설정 및 약속 핵심 가치 파악, 시장에서의 프로젝트 경쟁력 강화
													</span>
												</p>
												<div
													className="exp-content err_cv_content"
													...
													cvo-placeholder=" 업무에서 달성되는 업무 세부 사항을 설명한다."
												>
													결과: 프로젝트는 네티즌의 압도적인 투표로 실제에 정식적으로 적용된다.
													<br />{' '}
												</div>
											</div>{' '}
										</div>
