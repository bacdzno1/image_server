				...
				<div id="form-cv">
								...
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '3.675px' }}>
												{' '}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '3.675px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: '3.675px' }}
														>
															Mong muốn được làm việc ở trong môi trường chuyên nghiệp, có nhiều cơ hội phát huy kinh nghiệm, kiến thức vốn có. Đồng
															thời có thể bổ sung những kỹ năng và kinh nghiệm quý giá từ thực tế để hoàn thiện bản thân.&nbsp; <br />
															Đóng góp sức lực, trí tuệ để tạo nên sự phát triển vững mạnh cho Công ty. Từ đó được đón nhận nhiều cơ hội thăng tiến
															trong sự nghiệp.&nbsp;
															<br />{' '}
														</div>
													</div>
											...
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '3.675px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box04" className="block cvo-block ui-sortable-handle" style={{ marginTop: '3.675px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: '3.675px' }}
														>
															- Nhận khen thưởng sinh viên tích cực tham gia các hoạt động xã hội <br />- Khen thưởng nhân viên ưu tú cuối năm 2018
															tại Công ty Cổ phần kiến trúc và nội thất CV365
															<br />{' '}
														</div>
													</div>
												</div>
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '10.0667px' }}>
										<div id="experience-table">
											<div id="exp2" className="ctbx experience" style={{ marginTop: '7.55px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
												...
												>
													...
													<br />- Tư vấn và hỗ trợ cho các nhà thầu về mảng thiết kế, thi công, sản xuất mặt đường nhựa, bê tông.&nbsp;
											...
											<div id="exp3" className="ctbx experience" style={{ marginTop: '7.55px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
									...
									<div id="block03" className="cvo-block ui-sortable-handle" style={{ marginTop: '10.0667px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '7.55px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
									...
									<div id="block04" className="cvo-block ui-sortable-handle" style={{ marginTop: '10.0667px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
					...
					<div className="cv_page page_more height_page" data-page={3}>
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{ paddingBottom: '748.4px' }}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable" />
									</div>
