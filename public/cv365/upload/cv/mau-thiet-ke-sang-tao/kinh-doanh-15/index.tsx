											...
											<div id="box02" className="block cvo-block ui-sortable-handle">
												...
												<p>
													<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
														Khẳng định giá trị bản thân trong công việc là mục tiêu hàng đầu của tôi. Trong 2 năm tới, với những kinh nghiệm đã có, sự
														cố gắng trau dồi kiến thức và sự đam mê trong công việc, tôi tự tin mình sẽ trở thành 1 trưởng phòng CSKH trong tương lai.{' '}
													</span>
												</p>
											</div>
