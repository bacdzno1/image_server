...
<link id="cv-color-css" rel="stylesheet" href="upload/cv/<?php echo $item->alias; ?>/css/colors/<?php echo $color_active; ?>.css?v=<?= $styleVersion ?>?v=2" type="text/css">
...
<div id="page-cv">
    <div id="cv-title" class="non-printable" contenteditable="true" cvo-validatable="true" cvo-placeholder="<?php echo $holder_title_cv; ?>"><?php if(isset($cv_title) and $cv_title!=''){echo $cv_title;}else{ echo $item->name;}  ?></div>
    <div id="form-cv">
        <div id="cv-top">
            <div id="cvo-profile">
                <div class="box-01">
