                ...
                <div id="thongtin">
                    <div id="thongtin-item">
                        ...
                        ?>
                                ...
                                <div id="prof">
                                    <h3>
                                        <div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?>BACKGROUND INFORMATION</div>
                                    </h3>
                                    <div class="ic">
