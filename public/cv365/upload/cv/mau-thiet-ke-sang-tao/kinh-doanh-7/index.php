    ...
    <div id="form-cv">
        ...
        <div id="cv-top">
            ...
            <div class="box-info">
                ...
                ?>
                            ...
                            <p class="icoweb cvi-envelope-square"><i class="fa">&#xf0e0</i> <span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                                                                                    echo $email;
                                                                                                                                                                                                } else {
        ...
        <div class="all">
            <div id="cv-main">
                        ...
                        ?>
                                <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if ($block['status'] == 'hide') {
                                    ...
                                    <p class="icf">
                                        ...
                                        switch ($i) {
                                            case 1:
                                                echo '<i class="fa">&#xf0f2</i>';
                                                break;
                                            case 2:
                                                echo '<i class="fa">&#xf007</i>';
                                                break;
                                            case 3:
                                                echo '<i class="fa">&#xf2b9</i>';
                                                break;
                                            case 4:
                                                echo '<i class="fa">&#xf067</i>';
                                                break;
                                            default:
                                                echo '<i class="fa">&#xf041</i>';
                                                break;
                                        }
                                        ?>
                                    </p>
                ...
                <div class="bg_cv" style="margin-bottom: 0px;"></div>
