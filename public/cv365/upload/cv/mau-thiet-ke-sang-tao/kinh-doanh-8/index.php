                     ...
                     <div class="ir">
                        <div id="sortable">
                            ...
                            <?php if($m['type']=="profile"){ ?> 
                                <div class="cum">
                                    <div class="ww">
                                    <div class="icf"><i class="fa">&#xf067</i></div>
                                </div>
                            ...
                            <?php }else{ ?>
                                ...
                                <div id="box-content" ><span class="box-content" cvo-placeholder="<?php echo $holder_box_content; ?>" contenteditable="true">
                                    <?php echo $m['content']; ?>
                                </span></div>
                            <?php } 
                            echo '</div>';
