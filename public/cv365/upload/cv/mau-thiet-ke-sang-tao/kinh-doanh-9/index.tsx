												...
												<div id="experience-table">
													<div id="exp1" className="ctbx experience">
														...
														<div
															...
															cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
														>
															- Thiết lập mạng lưới nhà phân phối, đại lý bánh kẹo khu vực quận Hoàng Mai thông qua: Quảng cáo, giới thiệu chương
															trình khuyến mãi, …<br />- Tiếp cận, chăm sóc khách hàng đại lý cũ – mới trong khu vực quận Hoàng Mai: Giải đáp khó
															khăn, đưa các chương trình mới của công ty, báo giá hàng hóa, tư vấn dịch vụ…
															<br />- Đi đến các đại lý làm việc: Sản lượng tháng, hoa hồng tháng, …<br />- Làm việc với các đơn vị vận chuyển hàng
															hóa.
													...
													<div id="exp2" className="ctbx experience">
														...
														>
															...
															<br />- Đăng thông tin quảng cáo bất động sản trên internet (diễn đàn, mạng xã hội, rao vặt, website về bất động sản) để
															tìm kiếm nguồn khách hàng.
															<br />- Quản lý khách hàng, chăm sóc khách hàng trước – trong – sau khi chốt hợp đồng. Cụ thể: Gọi điện tư vấn, đưa
															khách hàng đi xem nhà, chốt hợp đồng với khách hàng mục tiêu…
															<br />- Hỗ trợ pháp lý cho khách hàng về thủ tục liên quan mua bán nhà và phối hợp với bộ phận Marketing để gia tăng
												...
												<div id="experience-table">
													<div id="exp1" className="ctbx experience">
														...
														<div
															...
															cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
														>
															Dự án “ Giải cứu dưa hấu miền trung” được thực hiện với đội thanh niên xung kích trường bán tại cổng trường Đại học
															CV365{' '}
														</div>
													</div>
												</div>
										...
										<div className="ir">
											<div id="sortable" className="ui-sortable">
												...
												<div id="box02" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
															Trong cuộc sống hay công việc tôi luôn đặt mục tiêu cho mình để phấn đấu hoàn thành nó, là kim chỉ nam giúp tôi có động
															lực để làm việc hơn.
															<br />
												...
												<div id="box05" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
															- Chứng chỉ hoàn thành khóa học chương trình WE (Working Efficiency), đây là chương trình do Viện Quản lý Kinh doanh
															Quốc tế (IBM) kết hợp với Đại học Kinh doanh quốc tế Thụy Sĩ xây dựng
															<br />- Chứng chỉ hoàn thành khóa tiếng anh giao tiếp: “ Tự tin giao tiếp với người bản ngữ”&nbsp; trung tâm tiếng anh
															CV365
															<br />{' '}
														</span>
													</p>
												...
												<div id="box06" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
															- Nghe nhạc
															<br />- Xem phim
															<br />- Đi du lịch kết hợp chụp ảnh&nbsp;
															<br />- Thể thao: Đá bóng, bơi lội…&nbsp;{' '}
														</span>
													</p>
												</div>
