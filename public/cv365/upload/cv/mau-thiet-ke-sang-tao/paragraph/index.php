                ...
                <div class="ir">                    
                    <div id="sortable">
						...
						<?php }else if($m['type']=="skill"){ ?>
                            <?php echo $controls; ?>
                            <div class="wfa"><i class="fa">&#xf209;</i></div>
						...
						<?php }else{ ?>
                            <?php echo $controls; ?>
                            <div class="wfa">
                                <?php if($i==4){echo '<i class="fa">&#xf2bd;</i>';
                                }elseif($i==5){echo '<i class="fa">&#xf02d;</i>';}else{
                                    echo '<i class="fa">&#xf02e;</i>';
                                }
                                ?>
                            </div>
        ...
        <div id="cv-content">
            <div class="ir" id="sort_block">
                ...
                <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?>>                    
                    <?php echo $controls; ?>
                    <div class="wfa">
                        <?php if($i==2){echo '<i class="fa">&#xf2bd;</i>';
                        }elseif($i==3){echo '<i class="fa">&#xf05a;</i>';
                        }elseif($i==4){echo '<i class="fa">&#xf2bd;</i>';}else{
                            echo '<i class="fa">&#xf02d;</i>';
                        }
                        ?>
                        </div>
