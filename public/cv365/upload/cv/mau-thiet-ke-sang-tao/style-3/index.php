                ...
                <div class="ir">                    
                    <div id="sortable">
						...
						<?php }else if($m['type']=="skill"){ ?>
                            <?php echo $controls; ?>
                        <h3><div class="wfa"><i class="fa">&#xf209;</i></div><div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div></h3>
						...
						<?php }else{ ?>
                            <?php echo $controls; ?>
                            <h3><div class="wfa"><i class="fa">&#xf02e;</i></div>
        ...
        <div id="cv-content">
            <div class="ir" id="sort_block">
                ...
                <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?>>                    
                    <?php echo $controls; ?>
                    <div class="head"><div class="wfa"><i class="fa">&#xf02d;</i></div>
