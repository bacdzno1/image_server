				...
				<div id="form-cv">
						...
						<div className="all" style={{ paddingTop: 0 }}>
									...
									<div className="ir">
										...
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '18.8px' }}>
												...
												<div className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true" style={{ marginTop: '18.8px' }}>
											...
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '18.8px' }}>
												...
												<div className="box-content" style={{ marginTop: '18.8px' }}>
													<div className="ctbx">
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '36.95px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '24.6333px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '36.95px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											...
											<div id="exp2" className="ctbx experience" style={{ marginTop: '24.6333px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
							...
							<div id="cv-content" style={{ paddingBottom: '393.8px' }}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
