				...
				<div id="form-cv">
						...
						<div className="all" style={{ paddingTop: 0 }}>
										...
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											...
											<div id="box02" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="内容" contentEditable="true">
													短期目标：使用已经学到的基础知识以运用并突出完成一个饲养技术员的工作长期目标:1-2年之内会成熟并发展专门技能，晋升班长岗位且不停地贡献、为公司的定向和长期目标出力。{' '}
												</div>
											</div>{' '}
										</div>
									</div>
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '0.25px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '0.166667px' }}>
												{' '}
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '0.25px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '0.166667px' }}>
												...
												<div className="exp-content err_cv_content" contentEditable="true" cvo-placeholder="描述具体工作, 在工作期间所得到的收获">
													主动寻找客户并根据要求咨询各种猫协助支付手续、给客户运输猫接受并处理客户对公司的疑问、意见展开管理公司在FB,
													website,..上的fanpage，每天登载相片并咨询协助设立每周营业额和赢利的综合报告{' '}
												</div>
											</div>
											<div id="exp2" className="ctbx experience" style={{ marginTop: '0.166667px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> 加
												...
												<div className="exp-content err_cv_content" contentEditable="true" cvo-placeholder="描述具体工作, 在工作期间所得到的收获">
													执行控管公司的SOP系统：修改、补充、颁布、取消...提出计划并根据已确认之计划执行审定 -
													校正按规定执行自检项目分析生产提出克服与防止办法接受客户的投诉，了解产品的错误原因并向客户回复{' '}
												</div>
											</div>{' '}
										</div>
										<div className="form" />
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
									...
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											...
											<div id="box04" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="内容" contentEditable="true">
													“2017年优秀工团干部”奖状越南农业学院 - “2017年收益专业英语”比赛之第一奖{' '}
												</div>
											</div>
											...
											<div id="box07" className="block cvo-block ui-sortable-handle">
												...
												<div className="box-content err_cv_content" cvo-placeholder="内容" contentEditable="true">
													黎成禄先生CV365&nbsp; Kitty 猫责任有限公司SĐT电话号码: 033 888 9999{' '}
												</div>
											</div>
										</div>
									</div>
							...
							<div id="cv-content" style={{ paddingBottom: 464 }}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block03" className="cvo-block ui-sortable-handle" style={{ marginTop: 0 }}>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: 0 }}>
												...
												<h3>
													<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="公司名称">
														SOS儿童A举办收买旧书的节目用于在迎接新学生展览会上展示村协助队之志愿学生
													</div>
												</h3>
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="工作岗位" contentEditable="true">
