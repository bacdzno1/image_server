						...
						<div id="cv-main">
									...
									<div id="box-hvt">
										...
										<div className="box-info">
											<div id="box01" className="block cvo-block box-contact">
												{' '}
												<div id="birthday">
													<p className="icoweb cvi-birthday"></p>
													<div id="item-chung">
														<div className="icon">
															<i id="fa" className="fa">
																
															</i>
														</div>
														<div className="text-chung">
												...
												<div id="phone">
													<p className="icoweb cvi-phone"></p>
													<div id="item-chung">
														<div className="icon">
															<i id="fa" className="fa">
																
												...
												<div id="mail">
													<p className="icoweb cvi-envelope-square"></p>
													<div id="item-chung">
														<div className="icon">
															<i className="fa"></i>
														</div>
												...
												<div id="location">
													<p className="icoweb cvi-map-marker"></p>
													<div id="item-chung">
														<div className="icon">
															<i className="fa"></i>
														</div>
							...
							<div id="name-job">
								<div className="hr-left">
									<div className="hr-left-item" />
								</div>
								<div className="name-job-item">
									<p>ứng tuyển</p>
									<h2>
										...
										<div id="box02" className="block cvo-block ui-sortable-handle">
											...
											<p>
												<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
													Với sự yêu thích con người và văn hóa Nhật Bản tôi đến với nghề biên dịch viên như một cơ duyên. Tốt nghiệp chuyên ngành
													ngôn ngữ Nhật, 1 năm làm việc tại Nhật tôi tin rằng sẽ đảm nhiệm tốt công việc tại quý công ty, tiến xa hơn trong công việc
													trở thành một biên dịch viên tiếng Nhật chuyên nghiệp. <br />
									...
									<div id="block03" className="cvo-block ui-sortable-handle">
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience">
												...
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
														- Tham gia hoạt động ngoại khóa, các chương trình lễ hội của Nhật Bản được tổ chức tại Hà Nội: Tết Oshougatsu, Hội trợ
														Việt – Nhật, … trong thời gian học đại học cùng Đoàn thanh niên của khoa Ngôn ngữ Nhật.
													</span>
												</p>
												<div
													className="exp-content err_cv_content"
												...
												>
													...
													<br />{' '}
													<div>
														Thành viên: Tham gia buổi offline của CLB, Tình nguyện viên hướng dẫn du lịch của khách Nhật tham quan tại Hà Nội do CLB
														tổ chức. …<br />
													</div>{' '}
												</div>
											</div>{' '}
