									...
									<div id="box02" className="block cvo-block ui-sortable-handle">
										...
										<p>
											<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
												...
												ngữ Nhật, 1 năm làm việc tại Nhật tôi tin rằng sẽ đảm nhiệm tốt công việc tại quý công ty, tiến xa hơn trong công việc trở
												thành một biên dịch viên tiếng Nhật chuyên nghiệp. <br />
