            ...
            <div class="ir" id="sort_block">
                ...
                <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?>>
                    <?php echo $controls; ?>
                            ...
                            <div id="cvo-experience-blocktitle" class="block-title" style="font-weight: bold" cvo-placeholder="<?php echo $holder_block_title; ?>" contenteditable="true" ><?php echo $block['title']; ?></div>
                        </div>
