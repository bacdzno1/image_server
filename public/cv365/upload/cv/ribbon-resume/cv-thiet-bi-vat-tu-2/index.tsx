									...
									<div id="sortable" className="ui-sortable">
										...
										<div id="box02" className="block cvo-block ui-sortable-handle">
											...
											<div className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
												- Trở thành một nhân viên có nhiều kinh nghiệm trong lĩnh vực thu mua thiết bị và vật tư <br />- Cống hiện hết mình cho công
												việc và nhận được một mức thu nhập tương xứng.
												<br />{' '}
											</div>
										</div>
										<div id="box03" className="block cvo-block box-skills ui-sortable-handle">
											...
											<div className="exp content-edit skill">
												...
												<div className="ctbx">
													...
													<p className="skill-name" cv-form-field="true" contentEditable="true">
														Kỹ năng sử dụng thành thạo các chương trình tin học văn phòng có liên quan đến vị trí việc làm kỹ sư thiết bị điện: word,
														excel, autocard,..
													</p>
													<div className="bar-exp">
														<div style={{ width: '80%' }} />
										...
										<div id="box04" className="block cvo-block ui-sortable-handle">
											...
											<div className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
												- Cá nhân tham gia vào nhiều hoạt động xã hội được nhà trường khen tặng giấy khen <br />- Nhân viên tích cực tại Công ty Kiểm
												toán thiết bị vật tư CV365, nhận khen thưởng cuối năm 2018.
												<br />{' '}
											</div>
										</div>
									...
									<div id="experience-table">
										<div id="exp1" className="ctbx experience">
											...
											<div
												...
												cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
											>
												- Kiểm toán quyết toán vật tư thiết bị điện cho các dự án đã được hoàn thành <br />- Tập hợp, phân loại tài liệu, kiểm tra đối
												chiếu các danh mục thiết bị với các văn bản pháp lý của công trình
