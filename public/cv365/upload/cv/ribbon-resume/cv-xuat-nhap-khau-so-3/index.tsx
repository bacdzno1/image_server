												...
												<div id="experience-table">
													...
													<div id="exp2" className="ctbx experience">
														...
														>
															...
															<br />
															<div>
																- Writing a transaction email with the staff in charge of making the application, declaring the declaration and
																monitoring the shipment information for the customer.
																<br />
															</div>
															<div>
												...
												<div id="experience-table">
													<div id="exp1" className="ctbx experience">
														...
														<div
															...
															cvo-placeholder="Job description and task achievements."
														>
															Result: In 2018, Organic 365 Cosmetics - exclusive products have been distributed in 10 cosmetics stores of
															Timviec365.vn Cosmetic Company on Vietnam market.{' '}
														</div>
													</div>{' '}
												</div>
											</div>
												...
												<div id="box02" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Content" contentEditable="true">
															For me, the career objective is constantly learning experience in the actual working process, learning more about Import
															and Export knowledge about customs procedures, taxes, and quality control ... to get ahead in work.
															<br />
															Using your own experience and knowledge to become a professional export and import documentation staff and bring value
															to the Company. Helping the goods circulation process of the Company takes place quickly, accurately and effectively.
															<br />{' '}
														</span>
													</p>
												</div>
