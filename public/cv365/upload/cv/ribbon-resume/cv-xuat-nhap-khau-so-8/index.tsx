								...
								<div id="sortable" className="ui-sortable">
									...
									<div id="box02" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="Content" contentEditable="true">
											...
											<br />
											Using your own experience and knowledge to become a professional export and import documentation staff and bring value to the
											Company. Helping the goods circulation process of the Company takes place quickly, accurately and effectively.
											<br />{' '}
										</span>
									</div>
