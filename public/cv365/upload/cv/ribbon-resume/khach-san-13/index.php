                    ...
                    <div id="prof">
                        <div class="ic03">
                            <div class="ic">
                                ...
                                <div class="icoweb">
                                    <div id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></div>
                                </div>
                            </div>
                            <div class="ic">
                                <div class="icf"><i class="fa">&#xf228;</i></div>
                                <div class="icoweb">
                                    <div id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></div>
                                </div>
                            </div>
                            <div class="ic">
                                <div class="icf"><i class="fa">&#xf095;</i></div>
                                <div class="icoweb">
                                    <div id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="ic-email">
                            <div class="icf"><i class="fa">&#xf199;</i></div>
                            <div class="icoweb">
                                <div id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if (isset($email)) {
                                                                                                                                        echo $email;
                                                                                                                                    } else {
                        ...
                        <div class="ic-address">
                            <div class="icf"><i class="fa">&#xf041;</i></div>
                            <div class="icoweb">
                                <div id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></div>
                            </div>
                        </div>
                ...
                <div id="sortable">
                    ...
                    ?>
                            ...
                            <?php } else if ($m['type'] == "skill") { ?>
                                <?php echo $controls; ?>
                                <h3>
                                    <div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title">
            ...
            <div class="ir" id="sort_block">
                ...
                ?>
                        <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if ($block['status'] == 'hide') {
                            ...
                            <?php echo $controls; ?>
                            <div class="head">
                                <div id="cvo-experience-blocktitle" class="block-title" cvo-placeholder="<?php echo $holder_block_title; ?>" contenteditable="true">
                            ...
                            <div id="experience-table">
                                ...
                                ?>
                                    ...
                                    <?php if ($bl->subtitle != '') { ?>
                                        <div class="h3">
                                            <div class="exp-subtitle" cvo-placeholder="<?php echo $holder_block_job; ?>" contenteditable="true"><?php echo $bl->subtitle; ?></div>
                                        </div>
                                    <?php } ?>
