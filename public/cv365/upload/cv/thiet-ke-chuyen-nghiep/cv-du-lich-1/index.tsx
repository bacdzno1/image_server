								...
								<div id="sortable" className="ui-sortable">
									...
									<div id="box02" className="block cvo-block ui-sortable-handle">
										...
										<div className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
											Học hỏi, tích lũy thêm nhiều kinh nghiệm việc làm trong ngành du lịch, tham gia vào nhiều dự án quan trọng phát triển Công ty.
											<br />
											Mong muốn đảm nhận vị trí quản lý các tour du lịch tại Công ty. Mục tiêu sau 3 năm cống hiến sẽ giữ vị trí Quản lý điều hành du
											lịch.&nbsp;
											<br />{' '}
										</div>
										<div className="clr" />
