...
<div id="page-cv">
        ...
        <div id="cv-top">
            <div id="cvo-profile">
                <div id="box-hvt">
                    ...
                    <h1>
                        <div id="trans">
                            <span id="cv-profile-fullname" cvo-placeholder="<?php echo $holder_name; ?>" contenteditable="true"><?php echo $fullname; ?></span>
                        </div>
                    </h1>
    ...
    <!-- footer -->
    <div class="footer"><div class="watermark">© Timviec365.vn</div></div>
    <!-- footer -->
</div>
</div>