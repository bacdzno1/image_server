import { setDataForCV } from '@/components/taocv/tao_cv'
			...
			<div id="page-cv">
				...
				<div id="form-cv">
					<div className="cv_page height_page" data-page={1}>
										...
										<div id="cvo-profile-avatar-wraper">
											<div className="wimg">
												<img
													...
													cvo-form-field="true"
													src="/cv365/images/no_avatar.jpg"
												/>
											</div>
											...
											<div id="prof">
												<div className="ic2">
													...
													<div className="icoweb">
														<span
															id="cv-profile-sex"
															cvo-placeholder="Giới tính"
															contentEditable="true"
														>
															{html?.menu?.[0]?.content?.content?.content?.sex}
														</span>
													</div>
												</div>
												<div className="ic1">
												...
												<div className="ic3">
													...
													<div className="icoweb">
														...
														>
															{' '}
															{html?.menu?.[0]?.content?.content?.content?.phone}
														</span>
													</div>
												</div>
												<div className="ic4">
													...
													<div className="icoweb">
														<span
															...
															contentEditable="true"
														>
															{html?.menu?.[0]?.content?.content?.content?.email}
														</span>
													</div>
												</div>
												<div className="ic5">
													...
													<div className="icoweb">
														...
														>
															{' '}
															{html?.menu?.[0]?.content?.content?.content?.address}
														</span>
													</div>
												</div>
												<div className="clr" />
						...
						<div className="all" style={{ paddingTop: '40.25px' }}>
								...
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div
												id="box01"
												className="block cvo-block box-contact ui-sortable-handle"
												style={{ marginTop: '20.125px' }}
											>
												{' '}
													...
													<div className="ct_box">
														<div
															...
															dangerouslySetInnerHTML={{
																__html: html?.menu?.[1]?.content?.content,
															}}
														></div>
													</div>
												</div>
												...
												<div className="ski">
													...
													<div id="boxtitle">
														<div
															...
															className="box-title"
														>
															{html?.menu?.[2]?.content?.title}
														</div>
													</div>
												</div>
												<div className="exp content-edit skill">
													{html?.menu?.[2]?.content?.content?.skills?.map((item: any) => (
														<div className="ctbx">
										...
										<div className="head">
											...
											<div id="blocktitle">
												<div
													...
													contentEditable="true"
												>
													{html?.experiences?.[0]?.content?.title}
												</div>
											</div>
										</div>
												...
												>
													...
													<h3>
														...
														<div
															className="exp-date"
															contentEditable="true"
															cvo-placeholder="Thời gian làm việc"
														>
															{item?.date}
														</div>
													</h3>
													<p className="h3">
														<span
															...
															cvo-placeholder="Vị trí công việc"
															contentEditable="true"
														>
															{item?.subtitle}
														</span>
										...
										<div className="head">
											...
											<div id="blocktitle">
												<div
													...
													contentEditable="true"
												>
													{html?.experiences?.[1]?.content?.title}
												</div>
											</div>
										</div>
										<div id="experience-table">
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{ paddingBottom: 415 }}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: 0 }}
															dangerouslySetInnerHTML={{
																__html: html?.menu?.[3]?.content?.content,
															}}
														></div>
													</div>
												</div>
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: 0 }}
															dangerouslySetInnerHTML={{
																__html: html?.menu?.[4]?.content?.content,
															}}
														></div>
													</div>
												</div>
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: 0 }}
															dangerouslySetInnerHTML={{
																__html: html?.menu?.[5]?.content?.content,
															}}
														></div>
													</div>
												</div>
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: 0 }}
															dangerouslySetInnerHTML={{
																__html: html?.menu?.[6]?.content?.content,
															}}
														></div>
													</div>
												</div>
										...
										<div className="head">
											...
											<div id="blocktitle">
												<div
													...
													contentEditable="true"
												>
													{html?.experiences?.[2]?.content?.title}
												</div>
											</div>
										</div>
										<div id="experience-table">
											{html?.experiences?.[2]?.content?.content?.map((item: any, index: number) => (
												<div id={`exp${index + 1}`} className="ctbx experience">
													{' '}
													<div className="fieldgroup_controls">
														<div className="clone">
															<i className="fa fa-plus" /> Thêm
										...
										<div className="head">
											...
											<div id="blocktitle">
												<div
													...
													contentEditable="true"
												>
													{html?.experiences?.[3]?.content?.title}
												</div>
											</div>
										</div>
										<div id="experience-table">
										...
										<div className="head">
											...
											<div id="blocktitle">
												<div
													...
													contentEditable="true"
												>
													{html?.experiences?.[4]?.content?.title}
												</div>
											</div>
										</div>
										<div id="experience-table">
