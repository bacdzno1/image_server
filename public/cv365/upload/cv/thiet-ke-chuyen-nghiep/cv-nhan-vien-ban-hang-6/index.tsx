								...
								<div id="sortable" className="ui-sortable">
									...
									<div id="box02" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
											Mong muốn có thể đáp ứng tốt những yêu cầu từ khách hàng và mang lại cho khách sự phục vụ hài lòng nhất. Từ đó tạo hình ảnh tốt
											cho công ty.&nbsp;
											<br />
											Phấn đấu trở thành quản lý bán hàng khu vực của công ty, giúp công ty tìm ra những chiến lược kinh doanh mới phù hợp với xu thế
											phát triển của thị trường thương mại và tiến đến vượt target hàng tháng.
											<br />{' '}
										</span>
									</div>
								...
								<div id="experience-table">
									...
									<div id="exp2" className="ctbx experience">
										...
										>
											...
											<br /> - Giới thiệu và tư vấn sản phẩm tại cửa hàng, giải đáp thắc mắc của khách hàng trong quá trình bán hàng trực tiếp tại cửa
											hàng.&nbsp;{' '}
										</div>
									</div>
								...
								<div id="experience-table">
									<div id="exp1" className="ctbx experience">
										...
										>
											...
											<br />- Là thành viên của Câu lạc bộ Thắp sáng tương lai: Phát động quyên góp gây quỹ từ thiện giúp đỡ các em nhỏ mắc bệnh hiểm
											nghèo tại Trung tâm Y tế Tình Thương.
											<br />{' '}
										</div>
									</div>{' '}
								</div>
							...
							<div id="block04" className="cvo-block ui-sortable-handle">
								...
								<div id="experience-table">
									<div id="exp1" className="ctbx experience">
										...
										<p className="h3">
											<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
												- Vai trò trong dự án: Lên ý tưởng, lên thực đơn các sản phẩm cho cửa hàng; hỗ trợ hoạt động marketing quảng bá hình ảnh cửa
												hàng.
											</span>
										</p>
										<div
									...
									<div id="exp2" className="ctbx experience">
										...
										<p className="h3">
											<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
												- Vai trò trong dự án: Nhân viên phân tích thị trường, thu thập thông tin ý kiến khách hàng về sản phẩm của Công ty Cổ phần
												Thanh Toán CV365
											</span>
										</p>
										<div
