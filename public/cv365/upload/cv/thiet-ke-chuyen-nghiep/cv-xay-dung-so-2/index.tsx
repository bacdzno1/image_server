												...
												<div id="experience-table">
													<div id="exp1" className="ctbx experience">
														...
														>
															...
															<br /> - Làm việc với các bên thầu phụ, nhà cung cấp để đảm bảo đúng số lượng, mẫu mã, tiến độ công việc …<br />
															- Xem xét và duyệt khối lượng thanh toán cho nhà thầu phụ tại công trình
												...
												<div id="box02" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
															Áp dụng những kinh nghiệm và tích cực học hỏi những kiến thức chuyên ngành, kỹ năng chuyên môn để đóng góp sức lực cùng
															đưa công ty phát triển hơn nữa.
															<br />
															Mục tiêu dài hạn là trở thành 1 kỹ sư giỏi nắm vững những chuyên môn về hồ sơ nghiệm thu, kỹ thuật tổ chức thi công, dự
															toán công trình … để trở thành quản lý công trình xây dựng.
															<br />{' '}
														</span>
													</p>
												</div>
