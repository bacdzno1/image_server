                    ...
                    <div id="sortable">
                        ...
                        <?php if($m['type']=="profile"){ ?>
                            ...
                            <div id="prof">
                                ...
                                <div class="ic">
                                    <div class="icf">Số điện thoại:</div>
            ...
            <div class="ir" id="sort_block">
                <?php if(!empty($block_html)){
                    for($i=1;$i<=count($block_html);$i++){
                        $block = $block_html[$i];
                ?>
                <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?> style="padding:0px!important">
                    <?php echo $controls; ?>
                    <div class="sum">
                        <div class="sumic<?php echo$i?>"></div>
                                            <div class="head">
                            <div id="cvo-experience-blocktitle" style= "margin-left: 55px;margin-top: 7px"class="block-title" cvo-placeholder="<?php echo $holder_block_title; ?>" contenteditable="true"><?php echo $block['title']; ?></div>
                        </div>
                    </div>
