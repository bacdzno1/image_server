...
<script>
    // setInterval(setDistance(), 50);
    // function setDistance() {
    //     let height1 = $('.box-01 .chu').height();
    //     console.log(height1);
    //     let height2 = $('#box-hvt').height();
    //     console.log(height2);
    //     let height = `${-(height1 + height2) }px`;
    //     console.log(height);
    //     $("#cv-content").css("margin-top", height);
    //     console.log(9);
    // };
    $('#cv-profile-address').on('keyup', function() {
        let height1 = $(this).height();
        let height = `${(height1) - 160}px`;
        $("#cv-content").css("margin-top", height);
        console.log(height);
    })
</script>