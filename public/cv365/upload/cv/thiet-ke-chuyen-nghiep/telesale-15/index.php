            ...
            <div id="cvo-profile">
                <div class="box-01">
                    ...
                    <div id="box-hvt">
                        ...
                        <h2><?php echo $ut ?><div id="cv-profile-job" contenteditable="true" cvo-placeholder="<?php echo $holder_job; ?>"><?php echo $position; ?></div></h2>
                    </div>
                    <div class="clr"></div>
                </div>
            </div>
...
<!-- <script>
  let ranh = () => {
    ...
    if(Height2 == 35){
        $('#cv-profile-job').style.marginTop = `${-15}px`;
    }
