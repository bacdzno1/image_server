            ...
            <div id="cvo-profile">
                ...
                <div class="ifo">
                    <div class="chu">
                        ...
                        <div class="clr"></div>
                        <h2>
                            <div id="cv-profile-job" contenteditable="true" cvo-placeholder="<?php echo $holder_job; ?>"><?php echo $position; ?></div>
                        </h2>
                        <div class="clr"></div>
                    </div>
                </div>
                                ...
                                ?>
                                    ...
                                    <h3>
                                        ...
                                        <div class="b_l">
                                            ...
                                            <?php } ?>
                                            <?php if ($bl->subtitle != '') { ?>
                                                <p class="h3"><span class="exp-subtitle" cvo-placeholder="<?php echo $holder_block_job; ?>" contenteditable="true"><?php echo $bl->subtitle; ?></span></p>
                                            <?php } ?>
                                        </div>
                                    </h3>
