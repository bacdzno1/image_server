                ...
                <div class="ir">                    
                    ...
                    <div id="sortable">
                        ...
                        <?php }else if($m['type']=="skill"){ ?>
                            <?php echo $controls; ?>
                        <p class="h3"><span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></span><i class="fa fa-angellist"></i></p>
