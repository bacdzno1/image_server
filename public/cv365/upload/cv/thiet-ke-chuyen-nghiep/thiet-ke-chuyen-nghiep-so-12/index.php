                ...
                <div class="ir">
                    ...
                    <div id="sortable">
						...
						<?php if($m['type']=="profile"){ ?>		                            
                            ...
                            <p class="icoweb"><i class="fa fa-calendar scheme-color"></i><span id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></span></p>
                            <p class="icoweb"><i class="fa fa-user scheme-color"></i><span id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></span></p>
                            <p class="icoweb"><i class="fa fa-phone scheme-color"></i><span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></span></p>
                            <p class="icoweb"><i class="fa fa-envelope-square scheme-color"></i><span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if(isset($email)){echo $email;}else{echo $m['content']->email;} ?></span></p>
                            <p class="icoweb"><i class="fa fa-map-marker scheme-color"></i><span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></span></p>
                            <p class="icoweb"><i class="fa fa-info scheme-color"></i><span id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></span></p>
