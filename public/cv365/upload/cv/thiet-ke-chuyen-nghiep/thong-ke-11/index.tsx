            ...
            <div id="page-cv">
                ...
                <div id="form-cv">
                    <div className="cv_page height_page" data-page={1}>
                        ...
                        <div className="all" style={{ paddingTop: "7.1px" }}>
                    ...
                    <div className="cv_page page_more height_page" data-page={2}>
                        <div className="all" style={{ paddingTop: 0 }}>
                            <div id="cv-main" style={{ paddingBottom: "201.4px" }}>
                                <div id="cv-right">
                                    <div className="ir">
                                        <div
                                            id="sortable"
                                        ...
                                        >
                                            <div
                                                ...
                                                style={{ marginTop: "-13.4px", marginBottom: 2 }}
                                            >
                                                {" "}
                                                <div className="blockControls">
                                                    <div title="Di chuyển khối" className="show-layout-editor">
                            ...
                            <div id="cv-content">
                                ...
                                >
                                    ...
                                    <div
                                        id="block03"
                                        className="cvo-block ui-sortable-handle"
                                        style={{ marginTop: "0.0062499px", marginBottom: "1.35px" }}
                                    >
                                        <div className="blockControls">
                                            <div title="Di chuyển khối" className="show-layout-editor">
                                                <i className="fa fa-bars" />
