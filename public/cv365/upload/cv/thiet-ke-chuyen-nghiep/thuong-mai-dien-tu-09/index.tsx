			...
			<div id="page-cv">
				...
				<div id="form-cv">
					<div className="cv_page height_page" data-page={1}>
						...
						<div className="all" style={{ paddingTop: '34.328px' }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '25.746px' }}>
												{' '}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '25.746px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div
													...
													style={{ marginTop: '25.746px' }}
												>
													- Nắm vững kỹ năng cần thiết cho công việc trong thời gian thử việc <br />- Không ngừng bổ sung thêm kiến thức mức trong
													ngành Thương mại điện tử&nbsp; và trau dồi từ thực tế để có thể nâng cao hơn nữa các kỹ năng nghề nghiệp, có thể thực hiện
													tốt những công việc được giao phó.&nbsp;
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '14.418px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '9.612px' }}>
												{' '}
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '14.418px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											...
											<div id="exp2" className="ctbx experience" style={{ marginTop: '9.612px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
						...
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '12.4219px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box04" className="block cvo-block ui-sortable-handle" style={{ marginTop: '12.4219px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div
													...
													cvo-placeholder="Nội dung"
													contentEditable="true"
													style={{ marginTop: '12.4219px' }}
												>
													- Khen thưởng sinh viên tích cực trong công tác tình nguyện của trường Đại học Kinh tế - Luật <br />- Sinh viên xuất sắc
													trong lễ tốt nghiệp ra trường
													<br />- Nhân viên có nhiều đóng ý sáng tạo cho hoạt động Thương mại của Công ty TNHH Đầu tư CV365 Miền Bắc
													<br />{' '}
												</div>
											</div>
											<div id="box05" className="block cvo-block ui-sortable-handle" style={{ marginTop: '12.4219px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box06" className="block cvo-block ui-sortable-handle" style={{ marginTop: '12.4219px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
									...
									<div id="block04" className="cvo-block ui-sortable-handle">
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience">
												...
												<p className="h3">
													<span className="exp-subtitle" cvo-placeholder="Vị trí công việc" contentEditable="true">
														Vai trò: Lập kế hoạch phát triển hệ thống website thương hiệu cho công ty, quản lý các khâu trong quá trình thực hiện của
												...
												<div
													...
													cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
												>
													Mục tiêu dự án: Nâng cao hơn nữa tên tuổi của công ty, trở thành địa chỉ tin cậy, gần gũi với khách hàng. Từ đó thúc đẩy
					...
					<div className="cv_page page_more height_page" data-page={3}>
						<div className="all" style={{ paddingTop: 0 }}>
							...
							<div id="cv-content" style={{ paddingBottom: 473 }}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block" />
							</div>
