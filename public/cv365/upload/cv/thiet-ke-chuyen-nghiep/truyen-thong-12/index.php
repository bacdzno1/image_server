                    ...
                    <div id="sortable">
                        ...
                        <?php if($m['type']=="profile"){ ?>
                            <?php echo $controls; ?>
                             <?php echo $controls; ?>
                             <div class="cum">
                            <div class="cumicc2"></div>
                                <div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="标题" class="box-title">事业目标</div>
                          </div>
                             <div id="prof">
                                    <div class="ic">
                                    <div class="icf">出生日期:</div>
