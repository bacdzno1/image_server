            ...
            <div id="page-cv">
                ...
                <div id="form-cv">
                    <div className="cv_page height_page" data-page={1}>
                        ...
                        <div className="all" style={{ paddingTop: "30.65px" }}>
                    ...
                    <div className="cv_page page_more height_page" data-page={2}>
                        <div className="all" style={{ paddingTop: 0 }}>
                            ...
                            <div id="cv-content" style={{ paddingBottom: "506.4px" }}>
                                <div
                                    className="ir connectedSortable sort_block ui-sortable"
                                    id="sort_block"
                                >
