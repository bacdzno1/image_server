                      ...
                      <div class="ski">
						...
						<?php }else{ ?>
                          ...
                          <div class="cum">
							...
							<div id = "box-color" class="box-content" cvo-placeholder="<?php echo $holder_box_content; ?>" contenteditable="true">
                                <?php echo $m['content']; ?>
                            </div>
						<?php }
						echo '</div>';
...
?>
        	<div id="prof" >
                                ...
                                <div class="ic">
                                    <div class="icf"><i class="fa">&#xf129;</i></div>
                                    <div class="icoweb"><span id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></span></div>
                                </div>
                                <div class="clr"></div>
                            </div>
                            </div>
