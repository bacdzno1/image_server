...
export default function CV({
  ...
  ><div dangerouslySetInnerHTML={{ __html: `${html?.cv_title}` }} /></div>
  <div id="form-cv">
              ...
              <div className="chu">
                <h1>
                  <span
                    ...
                    contentEditable="true"
                  ><div dangerouslySetInnerHTML={{ __html: `${html?.name}` }} /></span>
                </h1>
                <div className="clr" />
                <h2>
                  <span
                  ...
                  ><div dangerouslySetInnerHTML={{ __html: `${html?.position}` }} /></span>
                </h2>
              </div>
              <div id="box-hvt">
                {/*php UTVT  */}
                    ...
                    <div className="ic ic2">
                      ...
                      <div className="icoweb">
                        <span
                          ...
                          contentEditable="true"
                        ><div dangerouslySetInnerHTML={{ __html: `${html?.menu[0]?.content?.content?.content?.phone}` }} /></span>
                      </div>
                    </div>
                    <div className="ic ic1">
                      <div className="icf">
                    ...
                    <div className="ic ic3">
                      ...
                      <div className="icoweb">
                        <span
                          ...
                          contentEditable="true"
                        ><div dangerouslySetInnerHTML={{ __html: `${html?.menu[0]?.content?.content?.content?.address}` }} /></span>
                      </div>
                    </div>
                    <div className="clr" />
                  </div>
    ...
    <div className="cv_page page_more height_page" data-page={2}>
      <div className="all" style={{ paddingTop: 0 }}>
        <div id="cv-main" style={{ paddingBottom: "159.4px" }}>
          <div id="cv-right">
            <div className="ir">
              <div
                id="sortable"
