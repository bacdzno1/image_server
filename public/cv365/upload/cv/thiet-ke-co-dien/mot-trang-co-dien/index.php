                    ...
                    <div id="sortable">
                        ...
                        if(!empty($menu_html)){
                            ...
                            <?php }else if($m['type']=="skill"){ ?>
                                <?php echo $controls; ?>
                                <h3><span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></span> <i class="fa">&#xf209;</i>
                                </h3>
                            ...
                            <?php }else{ ?>
                                <?php echo $controls; ?>
                                <h3>
                                    <span id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></span> <i class="fa">&#xf02e;</i></h3>
