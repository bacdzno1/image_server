                  ...
                  if(!empty($menu_html)){
                      for($i=1;$i<=count($menu_html);$i++){
                        ...
                        <?php }else if($m['type']=="skill"){ ?>
                            ...
                            <div class="ski">
                             <!-- <div class="skic"></div> -->
                             <h3><div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div>
                             </h3>
                         </div>
