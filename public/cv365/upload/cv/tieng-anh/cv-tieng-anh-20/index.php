                ...
                <div class="ir">                    
                    <div id="sortable">
						...
						<?php }else if($m['type']=="skill"){ ?>
                            <?php echo $controls; ?>
                        <div class="z-exp">
                        <div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div><div class="wfa"><i class="fa">&#xf0b1;</i></div></div>
                        <div class="clr"></div>
						...
						<?php }else{ ?>
                            <?php echo $controls; ?>
                            <div class="z-exp">
                                <div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div><div class="wfa"><i class="fa">&#xf02d;</i></div>
                            </div>
