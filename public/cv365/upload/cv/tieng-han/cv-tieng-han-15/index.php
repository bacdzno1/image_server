                    ...
                    <div id="sortable">
						...
						<?php if($m['type']=="profile"){ ?>
                            <div id="prof">
                                <?php echo $controls; ?>
                                <ul>
                                    <li><p class="icoweb cvi-date"><span id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></span></p></li>
                                    <li><p class="icoweb cvi-user"><span id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></span></p></li>
                                    <li><p class="icoweb cvi-phone"><span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></span></p></li>
                                    <li><p class="icoweb cvi-envelope-square"><span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if(isset($email)){echo $email;}else{echo $m['content']->email;} ?></span></p></li>
                                    <li><p class="icoweb cvi-map-marker"><span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></span></p></li>
                                    <li><p class="icoweb cvi-info"><span id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></span></p></li>
                                </ul>
                            </div>
                            <div class="clr"></div>
