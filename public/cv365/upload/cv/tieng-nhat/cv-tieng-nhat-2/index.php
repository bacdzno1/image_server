                    ...
                    <div class="clr"></div>
                        ...
                        <div id="sortable">
                            ...
                            for($i=1;$i<=count($menu_html);$i++){
                                $m = $menu_html[$i];
                                if($i%2 == 1){ echo '<div id="'.$m['id'].'" class="'.$m['class'].' bg2"';}else{
                                echo '<div id="'.$m['id'].'" class="'.$m['class'].'"';}
                                if($m['status']=='hide'){ echo ' style ="display:none"';}
                                echo '>';               
                            ?>                      
                            <?php if($m['type']=="profile"){ ?>
                                <p class="icoweb cvi-date"> <span id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></span> <i class="fa">&#xf1fd</i></p>
                                <p class="icoweb cvi-user"> <span id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></span> <i class="fa">&#xf224</i></p>
                                <p class="icoweb cvi-phone"> <span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php echo $m['content']->phone; ?></span> <i class="fa">&#xf2a0</i></p>
                                <p class="icoweb cvi-envelope-square"> <span id="cv-profile-email" cvo-placeholder="<?php echo $holder_email; ?>" contenteditable="true"><?php if(isset($email)){echo $email;}else{echo $m['content']->email;} ?></span> <i class="fa">&#xf0e0</i></p>
                                <p class="icoweb cvi-map-marker"> <span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $m['content']->address; ?></span> <i class="fa">&#xf041</i></p>
