                ...
                <div id="cv-top">
                    ...
                    <div class="box-info">
                            ...
                            for($i=1;$i<=count($menu_html);$i++){
                                ...
                                echo '>';               
                            ?>        
                                <p class="icoweb"><i class="fa">&#xf224</i><span id="cv-profile-sex" cvo-placeholder="<?php echo $holder_sex; ?>" contenteditable="true"><?php echo $m['content']->sex; ?></span></p>
                               <p class="icoweb"><i class="fa">&#xf1fd</i><span id="cv-profile-birthday" cvo-placeholder="<?php echo $holder_birthday; ?>" contenteditable="true"><?php echo $m['content']->birthday; ?></span></p>                                          
