                     ...
                     <div class="ir">
                        <div id="sortable">
    						...
    						<?php if($m['type']=="profile"){ ?>	
                                <p class="span span-date"><i class="fa">&#xf1fd</i></p>
                                ...
                                <p class="span span-user"><i class="fa">&#xf224</i></p>
                                ...
                                <p class="span span-phone"><i class="fa">&#xf2a0</i></p>
                                ...
                                <p class="span span-square"><i class="fa">&#xf0e0</i></p>
                                ...
                                <p class="span span-marker"><i class="fa">&#xf041</i></p>
            ...
            <div id="cv-content">
                    <div class="ir" id="sort_block">
                        ...
                        <div id="<?php echo $block['id']; ?>" class="cvo-block" <?php if($block['status']=='hide'){ echo ' style="display:none"'; }?>>                    
                            <?php echo $controls; ?>
                            <p class="ic_head"><i class="fa">&#xf0b1</i></p>
                            <p class="head">
