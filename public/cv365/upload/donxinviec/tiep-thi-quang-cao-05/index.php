...
<div id="page-letter">
	...
	<div id="form-letter">			
		...
		<div id="lt-content">
			<div class="ir">
				<div class="lt-box">
					<p  class="text-top"><span><?php echo $dxv_kg; ?></span> <span id="lto-user-to" cvo-placeholder="<?php echo $holder_kg; ?>" contenteditable="true"><?php echo $cv->user_to; ?></span></p>
					...
					<p class="text-top"><span><?php echo $dxv_dc; ?></span> <span id="lto-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $address; ?></span></p>
				</div>
