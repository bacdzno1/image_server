...
<div id="page-letter">
	...
	<div id="form-letter">			
		...
		<div id="lt-content">
			<div class="ir">
				<div class="lt-box">
					<p class="text"><?php echo $dxv_kg; ?> <span id="lto-user-to" cvo-placeholder="<?php echo $holder_kg; ?>" contenteditable="true"><?php echo $cv->user_to; ?></span></p>
					...
					<p class="address"><?php echo $dxv_dc; ?> <span id="lto-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php echo $address; ?></span></p>
				</div>
				<div id="lto-content" cvo-placeholder="<?php echo $holder_box_content; ?>" contenteditable="true">
					<?php echo $cv->content; ?>
				</div>
				<div class="end_write">
					<p class="ns"><span id="lto-local" cvo-placeholder="<?php echo $holder_city ; ?>" contenteditable="true"><?php echo $cv->local; ?></span>,
					...
					<p class="tx"><span id="lto-user_don" cvo-placeholder="<?php echo $holder_man; ?>" contenteditable="true"><?php echo $cv->user_don; ?></span></p>
				</div>
			</div>
		</div>		
		<div class="lt-ft">
